...
Para configurar o MailerSender, siga as instruções no arquivo [mailersend.md](https://github.com/4L1C3-R4BB1T/loja-virtual-dwa/blob/main/_docs/mailersend.md).

## Configuração do Mercado Pago

Para configurar o Mercado Pago, siga as instruções no arquivo [mercadopago.md](https://github.com/4L1C3-R4BB1T/loja-virtual-dwa/blob/main/_docs/mercadopago.md).
